...
/**
 * lucide-react dropped brand/social icons, so these small monoline glyphs
...
export function XIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M4 4l7.5 8.6L4.5 20H7l5.2-5.9L16.8 20H20l-8-9.2L18.7 4H16l-4.7 5.4L7.2 4H4Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      <path d="M8 10.5V17M8 7.5v.01" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
      <path
        d="M11.5 17v-4a2.2 2.2 0 0 1 4.4 0v4M11.5 10.5V17"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
